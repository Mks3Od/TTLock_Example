    ...
    switch (command) {
      ...
      case Command.modifyCard:
        if (addCardNumber == null) {
          _showErrorAndDismiss(
            TTLockError.cardNotExist,
            'please add an ic card first',
          );
          return;
        }
      ...
      case Command.modifyFingerprint:
        if (addFingerprintNumber == null) {
          _showErrorAndDismiss(
            TTLockError.fingerprintNotExist,
            'please add fingerprint first',
          );
          return;
        }
        TTLock.modifyFingerprintValidityPeriod(
          addFingerprintNumber!,
          null,
          startDate,
          endDate,
          lockData,
      ...
      case Command.setLiftWorkMode:
        TTLock.setLiftWorkMode(
          TTLiftWorkActivateType.allFloors,
          lockData,
          () {
            _showSuccessAndDismiss("Success");
          },
      ...
      case Command.setPowerSaverWorkMode:
        TTLock.setPowerSaverWorkMode(
          TTPowerSaverWorkType.allCards,
          lockData,
          () {
            _showSuccessAndDismiss("Success");
          },
      ...
      case Command.setPowerSaverControlAbleLock:
        TTLock.setPowerSaverControlAbleLock(
          this.lockMac,
          lockData,
          () {
            _showSuccessAndDismiss("Success");
      ...
      case Command.getPasscodeVerificationParams:
        TTLock.getPasscodeVerificationParams(
          lockData,
          (lockData) {
